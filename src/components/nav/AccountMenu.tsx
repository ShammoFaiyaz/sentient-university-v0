...
export function AccountMenu() {
  ...
  function switchMode(mode: "student" | "teacher" | "admin") {
    ...
    show({ title: "Mode switched", message: `Switched to ${label}`, variant: "success" });
    setOpen(false);
  }
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((v) => !v)}
        className="inline-flex items-center gap-2 rounded-full px-3 py-2 border border-line/60 bg-white shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:bg-primary/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary"
      >
